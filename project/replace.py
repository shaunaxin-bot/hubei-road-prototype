            ...
            <table class="w-full text-left text-base border-collapse">
              ...
              <tbody class="divide-y divide-slate-200 text-slate-700">
                <tr class="hover:bg-slate-50/80">
                  <td rowspan="12" class="p-2.5 font-bold text-red-600 border-r border-slate-200 text-center align-middle" style="writing-mode: vertical-rl; text-orientation: upright; letter-spacing: 4px;">初步验收</td>
                  <td rowspan="5" class="p-2.5 font-bold text-red-600 border-r border-slate-200 text-center align-middle" style="width: 140px;">1. 项目建设与交付类</td>
                ...
                <tr class="hover:bg-slate-50/80 border-t border-slate-200">
                  <td rowspan="2" class="p-2.5 font-bold text-red-600 border-r border-slate-200 text-center align-middle">2. 平台功能演示类</td>
                ...
                <tr class="hover:bg-slate-50/80 border-t border-slate-200">
                  <td rowspan="5" class="p-2.5 font-bold text-red-600 border-r border-slate-200 text-center align-middle">3. 治理过程与成果类</td>
                ...
                <tr class="hover:bg-slate-50/80 border-t-2 border-slate-300">
                  <td rowspan="3" class="p-2.5 font-bold text-red-600 border-r border-slate-200 text-center align-middle" style="writing-mode: vertical-rl; text-orientation: upright; letter-spacing: 4px;">最终验收</td>
                  <td rowspan="3" class="p-2.5 font-bold text-red-600 border-r border-slate-200 text-center align-middle">4. 试运行与终验类</td>
...
if start_idx != -1:
    ...
    new_content = content[:start_idx] + html_str + content[end_idx:]
