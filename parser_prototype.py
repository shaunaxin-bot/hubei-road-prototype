...
with codecs.open('../20260721/20260721-hubei-prototype.html', 'r', 'utf-8') as f:
    text = f.read()
      ...
      { stage: "公路资产数据运营", color: "#eab308", icon: "🛣️", tables: [
        { lcode: "L51", name: "L51（公路资产动态台账）", macroAgent: "01 规划计划处", subTables: [
          { name: "资产入账明细表", microAgent: "01 规划计划处", isCompiled: false }
                    ...
                    with codecs.open('../20260721/20260721-hubei-prototype.html', 'w', 'utf-8') as fw:
                        fw.write(new_text)
                    print('Successfully updated ../20260721/20260721-hubei-prototype.html')
                    break
